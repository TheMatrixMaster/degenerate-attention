...
class TransformerEncoder(Module):
    ...
    def forward(
        ...
        for mod in self.layers:
            output = mod(output, src_mask=mask, is_causal=is_causal, is_degenerate=is_degenerate, src_key_padding_mask=src_key_padding_mask_for_layers)
...
class TransformerDecoder(Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None,
                ...
                memory_key_padding_mask: Optional[Tensor] = None, is_degenerate: bool = False) -> Tensor:
