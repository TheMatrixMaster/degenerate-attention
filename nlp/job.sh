...
# python main.py --cuda --bptt 512 --emsize 600 --nhid 600 --nhead 6 --nlayers 6 --epochs 50 --model GPT2 --lr 5 --wandb --save $group/normal-seed-55.pt --seed 55
# python main.py --cuda --bptt 512 --emsize 600 --nhid 600 --nhead 6 --nlayers 6 --epochs 50 --model GPT2 --lr 5 --wandb --save $group/normal-seed-32.pt --seed 32
